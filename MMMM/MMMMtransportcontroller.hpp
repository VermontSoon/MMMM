...
#include "MMMMmultipathscheduler.hpp"


struct MMMMTransportCtlConfig : public TransPortControllerConfig
{
public:
    MMMMTransportCtlConfig();
...
/** @brief a transport algorithm class implementing the P2PTransportController interface
 * */
class MMMMTransportCtl : public MPDTransportController,
                         public MultiPathSchedulerHandler,
                         public SessionStreamCtlHandler,
                         public std::enable_shared_from_this<MMMMTransportCtl>
{
public:

    explicit MMMMTransportCtl(std::shared_ptr<TransPortControllerConfig> ctlConfig);

    ~ MMMMTransportCtl() override;
...
private:
    ...
    std::shared_ptr<MMMMTransportCtlConfig> m_transCtlConfig;/// transport module config
 ...
 * */
class MMMMTransportCtlFactory : public TransportControllerFactory
{
public:
    ~ MMMMTransportCtlFactory() override = default;
